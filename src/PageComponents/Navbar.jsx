...
function NavbarPage() {
	return (
		...
		<header className="bg-gradient-to-r from-[#103ce7] to-[#64e9ff] xl:h-16 h-max py-4 w-full font-libre font-bold text-white flex flex-col gap-4 justify-center items-center xl:flex-row xl:gap-0">
			...
			<nav className="xl:w-1/2 w-full flex flex-row gap-2 xl:gap-8 list-none list-inside justify-center items-center text-center h-full text-base m:text-lg xl:text-xl">
